...
ent-RandomHumanoidSyndieDisasterVictim = жертва катастрофы Синдикат роль призрака
    .desc = { "" }
ent-GorlexSecuritiesOfficerSpawner = охранник из Gorlex LCC спавнер роль призрака
    .desc = { ent-MarkerBase.desc }
ent-GorlexSecuritiesPilotSpawner = пилот из Gorlex LCC спавнер роль призрака
    .desc = { "" }
ent-TravelingEngineerSpawner = инженер из частной компании роль призрака
    .desc = { ent-MarkerBase.desc }
ent-TravelingEngineerSeniorSpawner = глава частной компании инженеров роль призрака
    .desc = { "" }
